...
static rustsecp256k1_v0_4_1_scratch* rustsecp256k1_v0_4_1_scratch_create(const rustsecp256k1_v0_4_1_callback* error_callback, size_t size) {
    const size_t base_alloc = ROUND_TO_ALIGN(sizeof(rustsecp256k1_v0_4_1_scratch));
    void *alloc = checked_malloc(error_callback, base_alloc + size);
    rustsecp256k1_v0_4_1_scratch* ret = (rustsecp256k1_v0_4_1_scratch *)alloc;
    if (ret != NULL) {
