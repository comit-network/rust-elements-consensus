...
SECP256K1_INLINE static void rustsecp256k1_v0_4_1_scalar_set_u64(rustsecp256k1_v0_4_1_scalar *r, uint64_t v) {
    r->d[0] = v;
    r->d[1] = 0;
    r->d[2] = 0;
    r->d[3] = 0;
...
static void rustsecp256k1_v0_4_1_scalar_sqr_512(uint64_t l[8], const rustsecp256k1_v0_4_1_scalar *a) {
#ifdef USE_ASM_X86_64
    __asm__ __volatile__(
    /* Preload */
    "movq 0(%%rdi), %%r11\n"
...
static void rustsecp256k1_v0_4_1_scalar_sqr(rustsecp256k1_v0_4_1_scalar *r, const rustsecp256k1_v0_4_1_scalar *a) {
    uint64_t l[8];
    rustsecp256k1_v0_4_1_scalar_sqr_512(l, a);
    rustsecp256k1_v0_4_1_scalar_reduce_512(r, l);
}
...
static void rustsecp256k1_v0_4_1_scalar_chacha20(rustsecp256k1_v0_4_1_scalar *r1, rustsecp256k1_v0_4_1_scalar *r2, const unsigned char *seed, uint64_t idx) {
    size_t n;
    size_t over_count = 0;
    uint32_t seed32[8];
    ...
    do {
        ...
        over1 = rustsecp256k1_v0_4_1_scalar_check_overflow(r1);
        over2 = rustsecp256k1_v0_4_1_scalar_check_overflow(r2);
        over_count++;
   } while (over1 | over2);
}
