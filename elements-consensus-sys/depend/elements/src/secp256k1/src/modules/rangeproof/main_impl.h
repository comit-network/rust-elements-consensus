 ...
 *  derived by running the following script with the sage mathematics software.
    ...
    print('%x %x' % H.xy())
 */
static const rustsecp256k1_v0_4_1_generator rustsecp256k1_v0_4_1_generator_h_internal = {{
...
int rustsecp256k1_v0_4_1_pedersen_commitment_parse(const rustsecp256k1_v0_4_1_context* ctx, rustsecp256k1_v0_4_1_pedersen_commitment* commit, const unsigned char *input) {
    ...
    rustsecp256k1_v0_4_1_pedersen_commitment_save(commit, &ge);
    return 1;
}
...
int rustsecp256k1_v0_4_1_pedersen_commitment_serialize(const rustsecp256k1_v0_4_1_context* ctx, unsigned char *output, const rustsecp256k1_v0_4_1_pedersen_commitment* commit) {
    ...
    rustsecp256k1_v0_4_1_pedersen_commitment_load(&ge, commit);

    output[0] = 9 ^ rustsecp256k1_v0_4_1_fe_is_quad_var(&ge.y);
