...
int rustsecp256k1_v0_4_1_ecdsa_sign_recoverable(const rustsecp256k1_v0_4_1_context* ctx, rustsecp256k1_v0_4_1_ecdsa_recoverable_signature *signature, const unsigned char *msg32, const unsigned char *seckey, rustsecp256k1_v0_4_1_nonce_function noncefp, const void* noncedata) {
    rustsecp256k1_v0_4_1_scalar r, s;
    int ret, recid;
    ...
    ret = rustsecp256k1_v0_4_1_ecdsa_sign_inner(ctx, &r, &s, &recid, msg32, seckey, noncefp, noncedata);
    rustsecp256k1_v0_4_1_ecdsa_recoverable_signature_save(signature, &r, &s, recid);
    return ret;
}

int rustsecp256k1_v0_4_1_ecdsa_recover(const rustsecp256k1_v0_4_1_context* ctx, rustsecp256k1_v0_4_1_pubkey *pubkey, const rustsecp256k1_v0_4_1_ecdsa_recoverable_signature *signature, const unsigned char *msg32) {
