...
#ifndef USE_NUM_NONE
static void rustsecp256k1_v0_4_1_scalar_get_num(rustsecp256k1_v0_4_1_num *r, const rustsecp256k1_v0_4_1_scalar *a) {
    unsigned char c[32];
    rustsecp256k1_v0_4_1_scalar_get_b32(c, a);
    rustsecp256k1_v0_4_1_num_set_bin(r, c, 32);
}

/** secp256k1 curve order, see rustsecp256k1_v0_4_1_ecdsa_const_order_as_fe in ecdsa_impl.h */
static void rustsecp256k1_v0_4_1_scalar_order_get_num(rustsecp256k1_v0_4_1_num *r) {
#if defined(EXHAUSTIVE_TEST_ORDER)
...
#endif
    rustsecp256k1_v0_4_1_num_set_bin(r, order, 32);
}
#endif
...
static void rustsecp256k1_v0_4_1_scalar_inverse(rustsecp256k1_v0_4_1_scalar *r, const rustsecp256k1_v0_4_1_scalar *x) {
    ...
    *r = 0;
    ...
    rustsecp256k1_v0_4_1_scalar x2, x3, x6, x8, x14, x28, x56, x112, x126;
    rustsecp256k1_v0_4_1_scalar u2, u5, u9, u11, u13;

    rustsecp256k1_v0_4_1_scalar_sqr(&u2, x);
    rustsecp256k1_v0_4_1_scalar_mul(&x2, &u2,  x);
    rustsecp256k1_v0_4_1_scalar_mul(&u5, &u2, &x2);
    rustsecp256k1_v0_4_1_scalar_mul(&x3, &u5,  &u2);
    rustsecp256k1_v0_4_1_scalar_mul(&u9, &x3, &u2);
    rustsecp256k1_v0_4_1_scalar_mul(&u11, &u9, &u2);
    rustsecp256k1_v0_4_1_scalar_mul(&u13, &u11, &u2);

    rustsecp256k1_v0_4_1_scalar_sqr(&x6, &u13);
    rustsecp256k1_v0_4_1_scalar_sqr(&x6, &x6);
    rustsecp256k1_v0_4_1_scalar_mul(&x6, &x6, &u11);

    rustsecp256k1_v0_4_1_scalar_sqr(&x8, &x6);
    rustsecp256k1_v0_4_1_scalar_sqr(&x8, &x8);
    rustsecp256k1_v0_4_1_scalar_mul(&x8, &x8,  &x2);

    rustsecp256k1_v0_4_1_scalar_sqr(&x14, &x8);
    for (i = 0; i < 5; i++) {
        rustsecp256k1_v0_4_1_scalar_sqr(&x14, &x14);
    }
    rustsecp256k1_v0_4_1_scalar_mul(&x14, &x14, &x6);

    rustsecp256k1_v0_4_1_scalar_sqr(&x28, &x14);
    for (i = 0; i < 13; i++) {
        rustsecp256k1_v0_4_1_scalar_sqr(&x28, &x28);
    }
    rustsecp256k1_v0_4_1_scalar_mul(&x28, &x28, &x14);

    rustsecp256k1_v0_4_1_scalar_sqr(&x56, &x28);
    for (i = 0; i < 27; i++) {
        rustsecp256k1_v0_4_1_scalar_sqr(&x56, &x56);
    }
    rustsecp256k1_v0_4_1_scalar_mul(&x56, &x56, &x28);

    rustsecp256k1_v0_4_1_scalar_sqr(&x112, &x56);
    for (i = 0; i < 55; i++) {
        rustsecp256k1_v0_4_1_scalar_sqr(&x112, &x112);
    }
    rustsecp256k1_v0_4_1_scalar_mul(&x112, &x112, &x56);

    rustsecp256k1_v0_4_1_scalar_sqr(&x126, &x112);
    for (i = 0; i < 13; i++) {
        rustsecp256k1_v0_4_1_scalar_sqr(&x126, &x126);
    }
    rustsecp256k1_v0_4_1_scalar_mul(&x126, &x126, &x14);

    /* Then accumulate the final result (t starts at x126). */
    t = &x126;
    for (i = 0; i < 3; i++) {
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u5); /* 101 */
    for (i = 0; i < 4; i++) { /* 0 */
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &x3); /* 111 */
    for (i = 0; i < 4; i++) { /* 0 */
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u5); /* 101 */
    ...
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u11); /* 1011 */
    for (i = 0; i < 4; i++) {
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u11); /* 1011 */
    ...
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u13); /* 1101 */
    for (i = 0; i < 4; i++) { /* 0 */
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u5); /* 101 */
    ...
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u9); /* 1001 */
    for (i = 0; i < 6; i++) { /* 000 */
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u5); /* 101 */
    ...
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &x8); /* 11111111 */
    for (i = 0; i < 5; i++) { /* 0 */
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u9); /* 1001 */
    ...
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &x2); /* 11 */
    for (i = 0; i < 6; i++) { /* 00 */
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(t, t, &u13); /* 1101 */
    ...
    rustsecp256k1_v0_4_1_scalar_mul(t, t, x); /* 1 */
    for (i = 0; i < 8; i++) { /* 00 */
        rustsecp256k1_v0_4_1_scalar_sqr(t, t);
    }
    rustsecp256k1_v0_4_1_scalar_mul(r, t, &x6); /* 111111 */
}
...
static void rustsecp256k1_v0_4_1_scalar_inverse_var(rustsecp256k1_v0_4_1_scalar *r, const rustsecp256k1_v0_4_1_scalar *x) {
    ...
    unsigned char b[32];
    rustsecp256k1_v0_4_1_num n, m;
    rustsecp256k1_v0_4_1_scalar t = *x;
    rustsecp256k1_v0_4_1_scalar_get_b32(b, &t);
    rustsecp256k1_v0_4_1_num_set_bin(&n, b, 32);
    rustsecp256k1_v0_4_1_scalar_order_get_num(&m);
    rustsecp256k1_v0_4_1_num_mod_inverse(&n, &n, &m);
    rustsecp256k1_v0_4_1_num_get_bin(b, 32, &n);
    rustsecp256k1_v0_4_1_scalar_set_b32(r, b, NULL);
    /* Verify that the inverse was computed correctly, without GMP code. */
    rustsecp256k1_v0_4_1_scalar_mul(&t, &t, r);
    CHECK(rustsecp256k1_v0_4_1_scalar_is_one(&t));
#else
