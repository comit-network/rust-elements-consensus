...
static void rustsecp256k1_v0_4_1_fe_inv(rustsecp256k1_v0_4_1_fe *r, const rustsecp256k1_v0_4_1_fe *a) {
    ...
    rustsecp256k1_v0_4_1_fe_mul(&t1, &t1, a);
    for (j=0; j<3; j++) {
        rustsecp256k1_v0_4_1_fe_sqr(&t1, &t1);
    }
    rustsecp256k1_v0_4_1_fe_mul(&t1, &t1, &x2);
...
static void rustsecp256k1_v0_4_1_fe_inv_var(rustsecp256k1_v0_4_1_fe *r, const rustsecp256k1_v0_4_1_fe *a) {
    ...
    unsigned char b[32];
    int res;
    rustsecp256k1_v0_4_1_fe c = *a;
    rustsecp256k1_v0_4_1_fe_normalize_var(&c);
    rustsecp256k1_v0_4_1_fe_get_b32(b, &c);
    rustsecp256k1_v0_4_1_num_set_bin(&n, b, 32);
    rustsecp256k1_v0_4_1_num_set_bin(&m, prime, 32);
    rustsecp256k1_v0_4_1_num_mod_inverse(&n, &n, &m);
    rustsecp256k1_v0_4_1_num_get_bin(b, 32, &n);
    res = rustsecp256k1_v0_4_1_fe_set_b32(r, b);
    (void)res;
    VERIFY_CHECK(res);
    /* Verify the result is the (unique) valid inverse using non-GMP code. */
    rustsecp256k1_v0_4_1_fe_mul(&c, &c, r);
    rustsecp256k1_v0_4_1_fe_add(&c, &negone);
    CHECK(rustsecp256k1_v0_4_1_fe_normalizes_to_zero_var(&c));
#else
#error "Please select field inverse implementation"
#endif
}

static void rustsecp256k1_v0_4_1_fe_inv_all_var(rustsecp256k1_v0_4_1_fe *r, const rustsecp256k1_v0_4_1_fe *a, size_t len) {
    ...
    i = 0;
    while (++i < len) {
        rustsecp256k1_v0_4_1_fe_mul(&r[i], &r[i - 1], &a[i]);
    }

    rustsecp256k1_v0_4_1_fe_inv_var(&u, &r[--i]);

    while (i > 0) {
        size_t j = i--;
        rustsecp256k1_v0_4_1_fe_mul(&r[j], &r[i], &u);
        rustsecp256k1_v0_4_1_fe_mul(&u, &u, &a[j]);
    }
...
static int rustsecp256k1_v0_4_1_fe_is_quad_var(const rustsecp256k1_v0_4_1_fe *a) {
#ifndef USE_NUM_NONE
    unsigned char b[32];
    rustsecp256k1_v0_4_1_num n;
    rustsecp256k1_v0_4_1_num m;
    /* secp256k1 field prime, value p defined in "Standards for Efficient Cryptography" (SEC2) 2.7.1. */
    static const unsigned char prime[32] = {
        0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
        0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,
    ...
    rustsecp256k1_v0_4_1_num_set_bin(&n, b, 32);
    rustsecp256k1_v0_4_1_num_set_bin(&m, prime, 32);
    return rustsecp256k1_v0_4_1_num_jacobi(&n, &m) >= 0;
#else
    rustsecp256k1_v0_4_1_fe r;
    return rustsecp256k1_v0_4_1_fe_sqrt(&r, a);
#endif
}
