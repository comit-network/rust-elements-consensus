...
static void rustsecp256k1_v0_4_1_gej_add_ge(rustsecp256k1_v0_4_1_gej *r, const rustsecp256k1_v0_4_1_gej *a, const rustsecp256k1_v0_4_1_ge *b) {
    ...
    infinity = rustsecp256k1_v0_4_1_fe_normalizes_to_zero(&r->z) * (1 - a->infinity);
...
static int rustsecp256k1_v0_4_1_gej_has_quad_y_var(const rustsecp256k1_v0_4_1_gej *a) {
    rustsecp256k1_v0_4_1_fe yz;
     ...
     * that of a->z. Thus a->y / a->z^3 is a quadratic residue iff a->y * a->z
       is */
    rustsecp256k1_v0_4_1_fe_mul(&yz, &a->y, &a->z);
    return rustsecp256k1_v0_4_1_fe_is_quad_var(&yz);
}
